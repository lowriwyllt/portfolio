    ...
    <div className="p-2 flex flex-col items-center pr-[60px]">
      ...
      <div className="w-full flex flex-col md:flex-row md:h-[70vh] min-h-[70vh] max-w-[1326px] md:w-4/5">
        {data.map((adventure) => {
          return (
            <div
              className={`flex justify-center items-center max-w-[70vh] grow hover:grow-[7] transition-flex duration-800 ease-in bg-red-700 bg-cover bg-no-repeat bg-center`}
