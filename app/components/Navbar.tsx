      ...
      <nav className="md:sticky top-0 md:top-16 flex flex-grow flex-row  items-center">
        {navItems.map((item, index) => (
          <Link
            ...
            className="text-darkPurple bg-cream first-letter:hover:text-lilac hover:bg-darkPurple flex gap-4 items-center transition-colors duration-300 rounded-md mx-2"
          >
